...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_REALTIME_URL: optionalString(z.string().min(1)),
  ...
  REALTIME_CORS_ORIGIN: optionalString(z.string().min(1)),
  ...
  GOOGLE_API_KEY: optionalString(z.string().min(1)),
  ...
  ELEVENLABS_API_KEY: optionalString(z.string().min(1)),
  ELEVENLABS_VOICE_ID: optionalString(z.string().min(1)),
  DEEPGRAM_API_KEY: optionalString(z.string().min(1)),
  ASSEMBLYAI_API_KEY: optionalString(z.string().min(1)),
  WHISPER_TRANSCRIPTION_MODEL: z.string().min(1).default("gpt-realtime-whisper"),
  TRANSCRIPTION_DEFAULT_PROVIDER: z.enum(["deepgram", "whisper", "assemblyai"]).default("whisper"),
  TRANSCRIPTION_DEFAULT_LANGUAGE: z.string().min(1).default("en"),
  ...
  CONNECTOR_WEBHOOK_SECRET: optionalString(z.string().min(16)),
  ...
  VOICE_SESSION_TTL_SECONDS: z.coerce.number().int().positive().default(900),
  ...
  STRIPE_ENTERPRISE_PRICE_ID: optionalString(z.string().min(1)),
  STRIPE_AI_TOKEN_METER_EVENT_NAME: optionalString(z.string().min(1)),
...
export const env = envSchema.parse({
  ...
  REALTIME_CORS_ORIGIN: process.env.REALTIME_CORS_ORIGIN,
  REALTIME_PRESENCE_TTL_SECONDS: process.env.REALTIME_PRESENCE_TTL_SECONDS,
  ...
  WHISPER_TRANSCRIPTION_MODEL: process.env.WHISPER_TRANSCRIPTION_MODEL,
  TRANSCRIPTION_DEFAULT_PROVIDER: process.env.TRANSCRIPTION_DEFAULT_PROVIDER,
  TRANSCRIPTION_DEFAULT_LANGUAGE: process.env.TRANSCRIPTION_DEFAULT_LANGUAGE,
  ...
  VOICE_SESSION_TTL_SECONDS: process.env.VOICE_SESSION_TTL_SECONDS,
